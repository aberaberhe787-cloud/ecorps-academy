...
export const translations: Record<Language, I18nTranslations> = {
  ...
  en: {
    ...
    home: {
      ...
      pillar2Desc: "Checkpoint validation ensuring deep understanding before progression.",
    ...
    curriculum: {
      ...
      pillarRecallDesc: "Checkpoint validation ensuring deep understanding before progression.",
