      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] md:hidden" role="dialog" aria-modal="true">
          ...
          <motion.div
            ...
            className="fixed inset-y-0 right-0 w-full max-w-[320px] sm:max-w-md bg-slate-950 border-l border-slate-800/90 shadow-2xl flex flex-col justify-between overflow-hidden overscroll-contain z-[9999]"
          >
            {/* Top Bar / Header */}
