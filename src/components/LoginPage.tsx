      ...
      <div className="w-full max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-6xl xl:max-w-7xl my-auto z-10">
        ...
        >
          ...
          >
            ...
            {/* Live Interactive Code/Prompt Preview Sandbox Card (Desktop & Tablet) */}
            <div className="hidden sm:block rounded-2xl border border-slate-800/90 bg-slate-900/80 p-4 sm:p-5 backdrop-blur-xl shadow-xl shadow-black/40 space-y-3">
              <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                <div className="flex items-center gap-2">
                  <div className="h-3 w-3 rounded-full bg-rose-500/80" />
                  <div className="h-3 w-3 rounded-full bg-amber-500/80" />
                  <div className="h-3 w-3 rounded-full bg-emerald-500/80" />
                  <span className="text-xs font-mono text-slate-400 ml-2">prompt_engineering_runtime.ts</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="inline-flex items-center gap-1 rounded bg-emerald-500/10 border border-emerald-500/30 px-2 py-0.5 text-[11px] font-mono text-emerald-400">
                    <CheckCircle2 className="h-3 w-3" /> Score: 98/100
                  </span>
                </div>
              </div>
              <div className="font-mono text-xs text-slate-300 space-y-1 overflow-x-auto">
                <p className="text-purple-400 font-semibold"><span className="text-slate-500">01</span> &lt;system_directive&gt;</p>
                <p className="text-blue-300 pl-4"><span className="text-slate-500">02</span> role: "Senior AI Systems Architect",</p>
                <p className="text-amber-300 pl-4"><span className="text-slate-500">03</span> reasoning_protocol: "Chain-of-Thought + ReAct",</p>
                <p className="text-emerald-300 pl-4"><span className="text-slate-500">04</span> constraints: ["Zero Hallucinations", "Strict JSON Schema"]</p>
                <p className="text-purple-400"><span className="text-slate-500">05</span> &lt;/system_directive&gt;</p>
              </div>
            </div>
