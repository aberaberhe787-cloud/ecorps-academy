...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="border-t border-slate-800/80 bg-slate-950/80 text-slate-400 text-xs py-10 pb-[calc(2.5rem+env(safe-area-inset-bottom,0px))] md:pb-10" id="ecorp-app-footer">
