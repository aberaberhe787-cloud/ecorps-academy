    ...
    <div className="app-view w-full max-w-full space-y-3.5 sm:space-y-8 lg:space-y-12 py-2 sm:py-6 pb-20 sm:pb-12">
          ...
          <div className="mt-3.5 sm:mt-5 grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 text-left">
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-950/60 p-3.5 sm:p-4">
              ...
              <div className="mt-1.5 flex gap-3 sm:gap-4">
                <div><p className="text-[10px] text-slate-400">Overall Progress</p><p className="text-base sm:text-lg font-bold text-white">{totalCompletedLessons}/12</p></div>
                <div><p className="text-[10px] text-slate-400">Weekly Goal</p><p className="text-base sm:text-lg font-bold text-emerald-400">{weeklyGoal}/5</p></div>
                <div><p className="text-[10px] text-slate-400">Streak/XP</p><p className="text-base sm:text-lg font-bold text-amber-300">{userProgress.streakDays} days</p></div>
              </div>
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-950/60 p-3.5 sm:p-4">
              ...
              <p className="mt-1.5 text-sm font-bold text-white">{userProgress.savedCustomPrompts.length} saved prompts</p>
              <p className="text-sm font-bold text-white">{userProgress.bookmarkedPatterns.length} bookmarked patterns</p>
              <button onClick={() => openSandbox("saved")} className="mt-2.5 w-full rounded-lg bg-blue-600 px-4 py-2 text-xs font-semibold text-white hover:bg-blue-500 transition-colors">Continue</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden w-full max-w-screen-xl mx-auto px-2.5 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          {/* Main Title */}
          <h1 className="mt-3 sm:mt-5 text-2xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight">
          ...
          {/* Subtitle */}
          <p className="mx-auto mt-2 sm:mt-4 max-w-2xl text-xs sm:text-base lg:text-lg text-slate-300 leading-relaxed">
            {t.home.heroSubtitle}
          </p>

          {/* Hero CTAs */}
          <div className="mt-4 sm:mt-8 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-2.5 sm:gap-4 max-w-md sm:max-w-none mx-auto">
            <button
              id="hero-start-learning-btn"
              onClick={() => setActiveTab("curriculum")}
              className="flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-5 py-2.5 sm:px-6 sm:py-3 text-xs sm:text-sm font-bold text-white shadow-lg shadow-blue-500/25 transition-all hover:brightness-110 active:scale-95"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-xl border border-slate-700 bg-slate-900/90 px-5 py-2.5 sm:px-6 sm:py-3 text-xs sm:text-sm font-semibold text-slate-200 transition-all hover:bg-slate-800 hover:text-white"
            >
          ...
          <div className="mt-4 sm:mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 w-full">
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-2.5 sm:p-4">
              <span className="text-lg sm:text-2xl font-extrabold text-emerald-400 font-mono">5</span>
              <p className="text-[11px] sm:text-xs text-slate-400 mt-0.5">{t.home.statsMissions}</p>
            </div>
            <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-2.5 sm:p-4">
              <span className="text-lg sm:text-2xl font-extrabold text-purple-400 font-mono">6+</span>
              <p className="text-[11px] sm:text-xs text-slate-400 mt-0.5">{t.home.statsPatterns}</p>
            </div>
            <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-2.5 sm:p-4">
              <span className="text-lg sm:text-2xl font-extrabold text-amber-400 font-mono">100%</span>
              <p className="text-[11px] sm:text-xs text-slate-400 mt-0.5">{t.home.statsHandsOn}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900/90 p-3 sm:p-6 shadow-2xl backdrop-blur-md">
          ...
          <div className="mt-2.5 sm:mt-3">
            <textarea
              ...
              className="w-full rounded-xl border border-slate-800 bg-slate-950 p-2.5 sm:p-3 font-mono text-xs text-slate-200 focus:border-blue-500 focus:outline-none touch-pan-y overscroll-contain focus:touch-auto"
            />
          </div>

          <div className="mt-2.5 sm:mt-3 flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3">
            <div className="flex flex-wrap items-center gap-1.5">
              {quickAnalysis.techniqueBadges.map((badge, i) => (
                <span
                  key={i}
                  className="rounded bg-slate-800 border border-slate-700 px-2 py-0.5 text-[10px] sm:text-[11px] text-blue-300 font-medium"
                >
                  ✓ {badge}
                </span>
              ))}
      ...
      <section className="w-full max-w-screen-2xl mx-auto px-2.5 sm:px-6 lg:px-8 space-y-2 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 w-full">
          <div className="w-full max-w-full rounded-2xl border border-slate-800 bg-slate-900/70 p-3.5 sm:p-5 cursor-pointer hover:bg-slate-800 transition-colors" onClick={() => setActiveTab("curriculum")}>
            ...
            <p className="mt-1 sm:mt-1.5 text-xs text-slate-400 leading-relaxed">{t.home.pillar1Desc}</p>
          </div>

          <div className="w-full max-w-full rounded-2xl border border-slate-800 bg-slate-900/70 p-3.5 sm:p-5 cursor-pointer hover:bg-slate-800 transition-colors" onClick={() => setActiveTab("curriculum")}>
            <div className="flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 mb-2.5 sm:mb-3">
              <CheckCircle2 className="h-4 w-4" />
            </div>
            <h3 className="text-sm font-bold text-white">{t.home.pillar2Title}</h3>
            <p className="mt-1 sm:mt-1.5 text-xs text-slate-400 leading-relaxed">{t.home.pillar2Desc}</p>
          </div>

          <div className="w-full max-w-full rounded-2xl border border-slate-800 bg-slate-900/70 p-3.5 sm:p-5 cursor-pointer hover:bg-slate-800 transition-colors" onClick={() => setActiveTab("curriculum")}>
            <div className="flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-lg bg-purple-500/10 border border-purple-500/20 text-purple-400 mb-2.5 sm:mb-3">
              <Cpu className="h-4 w-4" />
            </div>
            <h3 className="text-sm font-bold text-white">{t.home.pillar3Title}</h3>
            <p className="mt-1 sm:mt-1.5 text-xs text-slate-400 leading-relaxed">{t.home.pillar3Desc}</p>
          </div>

          <div className="w-full max-w-full rounded-2xl border border-slate-800 bg-slate-900/70 p-3.5 sm:p-5 cursor-pointer hover:bg-slate-800 transition-colors" onClick={() => setActiveTab("playground")}>
            <div className="flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-lg bg-amber-500/10 border border-amber-500/20 text-amber-300 mb-2.5 sm:mb-3">
              <Terminal className="h-4 w-4" />
            </div>
            <h3 className="text-sm font-bold text-white">{t.home.pillar4Title}</h3>
            <p className="mt-1 sm:mt-1.5 text-xs text-slate-400 leading-relaxed">{t.home.pillar4Desc}</p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full max-w-screen-2xl mx-auto px-2.5 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-2 sm:gap-4 mb-3 sm:mb-6">
          <div>
            ...
            <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold tracking-tight text-white">
              {t.home.tracksTitle}
            </h2>
          ...
          {currentCurriculum.slice(0, 4).map((mod) => {
            ...
            return (
              <div
                key={mod.id}
                onClick={() => setActiveTab("curriculum")}
                className="group relative flex flex-col justify-between rounded-2xl border border-slate-800 bg-slate-900/60 p-3.5 sm:p-5 hover:border-slate-700 hover:bg-slate-900 transition-all cursor-pointer w-full max-w-full"
              >
                <div>
      ...
      <section className="w-full max-w-screen-2xl mx-auto px-2.5 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 w-full">
          {promptPatterns.slice(0, 3).map((pat) => (
            <div
              key={pat.id}
              className="group flex flex-col justify-between rounded-2xl border border-slate-800 bg-slate-900/60 p-3.5 sm:p-5 hover:border-slate-700 hover:bg-slate-900 transition-all w-full max-w-full"
            >
              <div>
                <div className="flex items-center justify-between mb-2 sm:mb-3">
                ...
                <p className="mt-1 sm:mt-2 text-xs text-slate-400 line-clamp-2 leading-relaxed">
                  {pat.description}
                </p>
              </div>

              <div className="mt-3.5 sm:mt-5 pt-3 sm:pt-4 border-t border-slate-800/80 flex items-center justify-between">
                <button
                  onClick={() => {
                    loadIntoPlayground({
                      prompt: pat.template,
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 sm:gap-6">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              <button
                ...
                onClick={() => openSandbox("sandbox")}
                className="flex items-center gap-2 rounded-xl bg-slate-800 border border-slate-700 px-3.5 py-2 sm:px-4 sm:py-2.5 text-xs font-bold text-slate-200 hover:bg-slate-700 transition-colors"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-xl bg-purple-600 px-3.5 py-2 sm:px-4 sm:py-2.5 text-xs font-bold text-white hover:bg-purple-500 transition-colors"
              >
      ...
      <section className="w-full max-w-screen-2xl mx-auto px-2.5 sm:px-6 lg:px-8">
        <div className="rounded-2xl sm:rounded-3xl border border-slate-800 bg-gradient-to-b from-slate-900/90 to-slate-950 p-3.5 sm:p-8 lg:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8 items-center">
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="pt-1 sm:pt-2">
                <button
                  ...
                  className="w-full sm:w-auto flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-2 sm:px-5 sm:py-2.5 text-xs font-bold text-white shadow-md hover:bg-blue-500 transition-all"
                >
            ...
            <div className="rounded-xl sm:rounded-2xl border border-slate-800 bg-slate-950 p-3.5 sm:p-5 font-mono text-xs text-slate-300 space-y-2 sm:space-y-2.5">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-slate-950/95 border-t border-slate-800 backdrop-blur-md px-3 py-2 sm:px-4 sm:py-3 md:hidden flex items-center justify-between gap-2.5 shadow-2xl">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-2 sm:px-5 sm:py-2.5 text-xs font-bold text-white shadow-lg shadow-blue-500/25 active:scale-95 shrink-0 min-h-[40px]"
        >
