...
export const PatternLibraryView: React.FC = () => {
  ...
  return (
    <div className="app-view w-full max-w-7xl mx-auto px-2.5 sm:px-6 lg:px-8 py-2.5 sm:py-6 space-y-3 sm:space-y-6 pb-20 sm:pb-6 ">
      {/* Header */}
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="rounded bg-slate-800 px-2 py-0.5 text-xs sm:text-xs font-semibold text-blue-300 font-mono">
                          {pattern.category}
                        </span>
                        <span className="text-xs sm:text-xs text-slate-500 font-medium">
                          {pattern.difficulty}
                        </span>
                      </div>
                  ...
                  <div className="mt-3 flex flex-wrap items-center gap-1.5">
                    {pattern.tags.slice(0, 3).map((tag, i) => (
                      <span
                        key={i}
                        className="rounded-md bg-slate-900 border border-slate-800 px-2 py-0.5 text-xs sm:text-xs text-slate-400"
                      >
                        #{tag}
                      </span>
                    ))}
